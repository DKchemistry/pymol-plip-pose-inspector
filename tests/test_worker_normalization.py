...
from pymol_plip.worker import normalize_interactions
...
class WorkerNormalizationTests(unittest.TestCase):
    def test_all_supported_classes_are_present(self):
        ...
        complex_ = NS(
            ...
            pication_paro=[],
            metal_complexes=[NS(**residue, metal=atom(0, 0, 0), target=atom(1, 0, 0), distance=1, location="protein", geometry="tetrahedral", metal_type="ZN")],
        )
