...
class SettingsDialog(QtWidgets.QDialog):
    def __init__(self, controller: Any, parent: QtWidgets.QWidget | None = None):
        ...
        self.setWindowTitle("Ligand Review Settings")
        self.setModal(False)
        self.resize(720, 260)
        ...
        note = QtWidgets.QLabel(
            ...
            "The recommended environment is named pymol-ligand-review."
        )
...
class LigandReviewDialog(QtWidgets.QDialog):
    def __init__(self, controller: Any, parent: QtWidgets.QWidget | None = None):
        ...
        self.setWindowTitle("Ligand Review Panel")
        self.setModal(False)
        self.resize(760, 790)
    ...
    def _show_error(self, message: str) -> None:
        ...
        QtWidgets.QMessageBox.warning(self, "Ligand Review Panel", message)
